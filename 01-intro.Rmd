...
Durante la decada de 1950, se desarrollan los primeros lenguajes de bajo nivel, los **assemblers**, sin embargo, cada vez más los requerimientos eran mayores, los problemas más difícles, los algoritmos más complejos. Pronto se hizo evidente que escribir código en Assembler, si bien mejor que hacerlo directamente en el código de la maquina, era inviable. Nace el primer lenguaje de alto nivel: **FORTRAN**. 





Con esto ya tenemos los tres niveles de lenguajes que aún perduran hoy:

* Lenguaje de maquina: el código binario que entiende directamente la computadora
* los lenguajes de bajo nivel: Aquellos lenguajes más amigables con el programador, que tienen un conjunto limitado de instrucciones o sentencias y que Assembler, C
* Los de alto nivel: FORTRAN, BASIC, R, Python, Java, etc.
